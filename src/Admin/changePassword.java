...
public class changePassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Admin/21.JPG"))); // NOI18N
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 320, 480));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            if (!validationChecker()) {
                ...
                ResultSet rs = new DBConnector().getData("select * from yang where id = '" + sess.getId() + "'");
                ...
                if (rs.next()) {
                    ...
                    if (oldPass.equals(oldHash)) {
                        ...
                        new DBConnector().updateData("update yang set pass = '" + newPass + "' where id = '" + sess.getId() + "'");
