...
public class editAccount extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Admin/21.JPG"))); // NOI18N
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 320, 480));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            if (updateChecker()) {
                ...
                new DBConnector().updateData("update yang set email = '" + email.getText() + "',user = '" + username.getText() + "', "
    ...
    private boolean updateChecker() throws SQLException {
        ResultSet rs = new DBConnector().getData("select * from yang where (user = '" + username.getText() + "' or email = '" + email.getText() + "') and id != '" + id.getText() + "'");
        if (rs.next()) {
